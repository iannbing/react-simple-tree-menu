...
v2 (recommended): `import 'react-simple-tree-menu/styles';`
...
The old path (`dist/main.css`) still works — we ship it as an alias for one
minor release — but it's documented-deprecated.
